...
public class MillerRabinPrimzahlTest {
	...
	public boolean miller_rabin(BigInteger N, int wiederholungen) {
	...
	public BigInteger modular_exponentiation(BigInteger A, BigInteger U,
			BigInteger N) {
	...
	public boolean witness(BigInteger A, BigInteger N) {
		...
		BigInteger U = N_1.divide(Big2.pow(s));
